...
const CACHE = 'raksha-v10';
const TILES = 'raksha-tiles-v1';
const TILE_CAP = 400;
const ASSETS = ['.', 'index.html', 'track.html', 'app.js', 'modes.js', 'features.js', 'brain.js', 'guardian.js', 'shield.js', 'check.js', 'extra.js', 'refine.js', 'v10.js', 'manifest.json', 'icon.svg',
